...
paddle_a.speed(0)
paddle_a.shape('square')#notice that we have not given the size yet so by default it is 20 by 20 pixels that means 20 pixels wide by 20 pixels high
...
paddle_b.speed(0)
paddle_b.shape('square')#notice that we have not given the size yet so by default it is 20 by 20 pixels that means 20 pixels wide by 20 pixels high
...
ball = turtle.Turtle()
ball.speed(0)
ball.shape('circle')#notice that we have not given the size yet so by default it is 20 by 20 pixels that means 20 pixels wide by 20 pixels high
ball.color('black')
ball.penup()
ball.goto(0,0)
ball.dx=0.25#what does this mean is everytime the ball moves in x axis it moves 0.25 pixels in the positive x direction 
ball.dy=-0.25#and ehat does this means is everytume the ball moves  in y axis it moves  0.25 pixels in the positive y direction 
