...
root.geometry('500x500')# window size (height, width )

                                                                     # Create canvas to display dots
canvas = tk.Canvas(root, width=500, height=500,bg='dark blue')      # specifications of canvas widget 
canvas.pack()# canvas widget 
